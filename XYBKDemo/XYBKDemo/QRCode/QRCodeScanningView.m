...
- (void)initialization {
    ...
    _scanningImageName = @"QRCode.bundle/QRCodeScanningLine";
}
...
- (void)addTimer {
    ...
    if (self.scanningAnimationStyle == ScanningAnimationStyleGrid) {
        ...
        self.scanningline.frame = CGRectMake(scanninglineX, scanninglineY, scanninglineW, scanninglineH);
    ...
    self.promptLabel.frame = CGRectMake(0, scanBorderW + scanBorderY + 50, self.frame.size.width, 30);
...
- (void)setScanningAnimationStyle:(ScanningAnimationStyle)scanningAnimationStyle {
    ...
    switch (scanningAnimationStyle) {
        case ScanningAnimationStyleDefault:
            _scanningImageName = @"QRCode.bundle/QRCodeScanningLine";
            break;
        case ScanningAnimationStyleGrid:
            _scanningImageName = @"QRCode.bundle/QRCodeScanningLineGrid";
        default:
            break;
    }
}
